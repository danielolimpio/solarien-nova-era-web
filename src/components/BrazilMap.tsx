            ...
            <div className="bg-white/80 rounded-xl p-6 border border-blue-100 mb-4">
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                <div className="text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-200">
                  <div className="p-3 bg-gradient-to-br from-green-600 to-emerald-600 rounded-full w-12 h-12 mx-auto mb-3 flex items-center justify-center">
                ...
                <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl border border-blue-200">
                  <div className="p-3 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-full w-12 h-12 mx-auto mb-3 flex items-center justify-center">
                ...
                <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl border border-purple-200">
                  <div className="p-3 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full w-12 h-12 mx-auto mb-3 flex items-center justify-center">
