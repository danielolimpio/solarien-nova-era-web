    ...
    <TooltipProvider>
      <section id="servicos" className="py-20 w-full bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          {/* Grupo A Information */}
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200 rounded-2xl p-6 mt-8 max-w-4xl mx-auto hover:animate-gentle-glow transition-all duration-300">
            <div className="text-center mb-6">
              <Tooltip>
                <TooltipTrigger asChild>
                  <h3 className="text-2xl font-bold text-gray-800 flex items-center justify-center gap-3 cursor-help hover:text-blue-700 transition-colors hover:animate-soft-pulse">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center">
                      <Factory className="w-6 h-6 text-white" />
                    </div>
                    Grupo A - Alta e Média Tensão
                    <div className="w-5 h-5 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center">
            ...
            <div className="bg-white/80 rounded-xl p-6 border border-blue-100 mb-4">
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 hover:animate-soft-pulse transition-all duration-300">
                  ...
                  <div className="text-2xl font-bold text-blue-700 mb-1">Até 45%</div>
                  <div className="text-blue-600 font-medium">Economia</div>
                </div>
                ...
                <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 hover:animate-soft-pulse transition-all duration-300">
                  ...
                  <div className="text-blue-600 font-medium">Contrato</div>
                </div>
                ...
                <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 hover:animate-soft-pulse transition-all duration-300">
                  ...
                  <div className="text-2xl font-bold text-blue-700 mb-1">180 dias</div>
                  <div className="text-blue-600 font-medium">Início da Injeção</div>
                </div>
              </div>

              {/* 100% Gratuito Badge */}
              <div className="text-center mb-6">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold py-3 px-6 rounded-full shadow-lg hover:animate-gentle-glow transition-all duration-300">
                  <div className="w-6 h-6 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center">
                    <Award className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-lg text-white">100% GRATUITO</span>
                </div>
              </div>

              {/* Sem Custos Features */}
              <div className="flex flex-wrap justify-center gap-4 text-center">
                <div className="flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-full border hover:animate-soft-pulse transition-all duration-300">
                  <div className="w-6 h-6 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center">
            ...
            <div className="text-center">
              <button
                ...
                className="bg-gradient-to-r from-blue-500 to-blue-700 text-white font-bold py-3 px-8 text-lg rounded-xl hover:shadow-xl hover:shadow-blue-600/30 transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 mx-auto hover:animate-gentle-glow"
              >
