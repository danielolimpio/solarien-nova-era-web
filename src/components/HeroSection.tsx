  ...
  return (
    <>
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Solar Rain Animation - Gotículas mais visíveis */}
        <div className="absolute inset-0 overflow-hidden">
          {/* Partículas principais - gotículas mais brilhantes */}
          {[...Array(150)].map((_, i) => (
            <div
              key={`drop-${i}`}
              className="absolute bg-gradient-to-b from-yellow-400/80 via-yellow-300/70 to-amber-400/60"
              style={{
                ...
                boxShadow: '0 0 15px rgba(255, 193, 7, 0.6), 0 0 25px rgba(255, 193, 7, 0.3)',
          ...
          {[...Array(200)].map((_, i) => (
            <div
              key={`med-drop-${i}`}
              className="absolute bg-gradient-to-b from-yellow-300/70 via-amber-300/60 to-orange-300/50"
              style={{
                ...
                borderRadius: '50% 50% 50% 50% / 60% 60% 40% 40%',
                boxShadow: '0 0 12px rgba(255, 193, 7, 0.5), 0 0 20px rgba(255, 193, 7, 0.2)',
                animation: `fall ${Math.random() * 5 + 5}s linear infinite`,
              }}
            />
          ))}
          
          {/* Micro partículas mais brilhantes */}
          {[...Array(300)].map((_, i) => (
            <div
              key={`micro-drop-${i}`}
              className="absolute bg-gradient-to-b from-amber-200/60 via-yellow-100/50 to-orange-100/40"
              style={{
                ...
                borderRadius: '50% 50% 50% 50% / 60% 60% 40% 40%',
                boxShadow: '0 0 10px rgba(255, 193, 7, 0.4), 0 0 15px rgba(255, 193, 7, 0.15)',
                animation: `fall ${Math.random() * 6 + 7}s linear infinite`,
              }}
            />
          ))}
          
          {/* Partículas intensas - destaque sutil */}
          {[...Array(80)].map((_, i) => (
            <div
              key={`intense-drop-${i}`}
              className="absolute bg-gradient-to-b from-yellow-400/90 via-amber-400/80 to-orange-300/70"
              style={{
                ...
                borderRadius: '50% 50% 50% 50% / 60% 60% 40% 40%',
                boxShadow: '0 0 20px rgba(255, 193, 7, 0.7), 0 0 35px rgba(255, 193, 7, 0.4)',
          ...
          {[...Array(400)].map((_, i) => (
            <div
              key={`bg-drop-${i}`}
              className="absolute bg-gradient-to-b from-amber-300/50 via-yellow-200/40 to-orange-200/30"
              style={{
