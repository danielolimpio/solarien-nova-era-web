  ...
  return (
    <>
      ...
      >
        ...
        {/* Efeitos de energia otimizados para mobile */}
        <div className="absolute inset-0 will-change-opacity" aria-hidden="true">
          <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 w-64 md:w-96 h-64 md:h-96 bg-gradient-radial from-[#02ff91]/30 via-[#02ff91]/15 to-transparent rounded-full blur-2xl md:blur-3xl animate-soft-pulse" />
          <div className="absolute top-1/3 right-1/4 w-48 md:w-64 h-48 md:h-64 bg-gradient-radial from-[#00c26f]/20 via-[#00c26f]/10 to-transparent rounded-full blur-xl md:blur-2xl animate-soft-pulse delay-1000" />
          <div className="absolute bottom-1/3 left-1/4 w-32 md:w-48 h-32 md:h-48 bg-gradient-radial from-[#00844e]/15 via-[#00844e]/8 to-transparent rounded-full blur-lg md:blur-xl animate-soft-pulse delay-2000" />
        </div>

        {/* Conteúdo principal com estrutura semântica otimizada para mobile */}
        <header className="relative z-10 text-center px-3 sm:px-4 pt-24 sm:pt-32 md:pt-20">
          <div className="max-w-4xl mx-auto">
            ...
            <div data-seo-context="energia-renovavel-limpa" className="mb-4 sm:mb-6">
              <TypewriterText texts={texts} />
            </div>
            
            <p 
              className="text-sm sm:text-lg md:text-xl text-gray-300 mb-4 sm:mb-6 max-w-2xl mx-auto leading-relaxed px-2"
            ...
            {/* Seção de benefícios com schema estruturado - Otimizada para mobile */}
            <div 
              className="flex flex-row justify-center items-center gap-2 sm:gap-4 md:gap-6 mb-8 sm:mb-12 hover:animate-soft-pulse transition-all duration-300 px-2" 
              itemScope 
            ...
            >
              {benefitsData.map(({ Icon, text }, index) => (
                <div key={text} className="flex items-center gap-1 sm:gap-2" itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                  <Icon className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-[#02ff91] flex-shrink-0" aria-hidden="true" />
                  <span className="text-gray-300 font-medium text-xs sm:text-sm md:text-base" itemProp="name">{text}</span>
            ...
            <div className="flex flex-col gap-4 sm:gap-6 justify-center items-center px-2">
              <DiscountSimulator>
                <Button 
                  className="w-full max-w-sm sm:w-auto bg-gradient-to-r from-[#02ff91] to-[#00c26f] hover:from-[#00c26f] hover:to-[#00844e] text-black font-bold px-6 sm:px-12 py-4 sm:py-6 text-sm sm:text-xl rounded-xl sm:rounded-2xl transition-all duration-300 transform hover:scale-105 sm:hover:scale-110 shadow-2xl border-2 border-[#02ff91] hover:border-[#00c26f] glow-effect hover:animate-gentle-glow will-change-transform touch-friendly"
              ...
              <Button 
                variant="outline" 
                className="w-full max-w-sm sm:w-auto border-2 sm:border-3 border-[#02ff91] text-[#02ff91] hover:bg-gradient-to-r hover:from-[#02ff91] hover:to-[#00c26f] hover:text-black font-bold px-6 sm:px-12 py-4 sm:py-6 text-sm sm:text-xl rounded-xl sm:rounded-2xl transition-all duration-300 transform hover:scale-105 sm:hover:scale-110 shadow-2xl hover:shadow-[#02ff91]/50 glow-effect hover:animate-gentle-glow will-change-transform touch-friendly"
          ...
          <div 
            className="mt-12 sm:mt-16 pb-6 sm:pb-8 md:pb-0 grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-4xl mx-auto px-2" 
            itemScope 
          ...
          >
            {statisticsData.map(({ value, label }) => (
              <div key={label} className="text-center hover:animate-soft-pulse transition-all duration-300">
                <div className="text-xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#02ff91] via-[#00c26f] to-[#00844e] bg-clip-text text-transparent mb-1 sm:mb-2" itemProp="description">{value}</div>
                <div className="text-gray-300 text-xs sm:text-sm md:text-base mb-4 md:mb-0 leading-tight">{label}</div>
              </div>
            ))}
          </div>
        </header>
      ...
      {/* Separador gradiente */}
      <div className="h-0.5 sm:h-1 w-full bg-gradient-to-r from-transparent via-[#02ff91] via-[#00c26f] to-transparent opacity-80" aria-hidden="true" />
    </>
  );
};
