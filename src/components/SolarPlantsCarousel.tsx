...
const SolarPlantsCarousel = () => {
  ...
  const solarPlants = [
    {
      ...
      description: 'Uma das maiores fazendas solares do Nordeste brasileiro com tecnologia de ponta em energia fotovoltaica'
    },
    {
      id: 2,
      ...
      description: 'Complexo de energia solar de grande escala com milhares de painéis fotovoltaicos gerando energia limpa'
    },
    {
      id: 3,
      ...
      description: 'Fazenda solar de grande porte gerando energia limpa e renovável para centenas de milhares de residências'
    },
    {
      id: 4,
      ...
      description: 'Instalação solar industrial de grande escala no interior paulista contribuindo para sustentabilidade'
    },
    {
      id: 5,
      ...
      description: 'Complexo fotovoltaico de grande porte contribuindo para o desenvolvimento regional sustentável'
    }
  ];
  ...
  return (
    <section 
      ...
      aria-labelledby="usinas-heading"
    >
      ...
      <div className="absolute inset-0">
        ...
        <img 
          ...
          alt="Overlay decorativo de energia solar" 
      ...
      <div className="w-full px-4 relative z-10">
        <header className="text-center mb-12">
          ...
          >
            <div className="w-10 h-10 bg-gradient-to-br from-solarien-primary to-solarien-secondary rounded-full flex items-center justify-center animate-[pulse_4s_ease-in-out_infinite]">
              <Sun className="w-6 h-6" style={{ color: '#002113' }} aria-hidden="true" />
            </div>
            <span className="text-gradient">Usinas</span> <span className="text-white">Solares</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Mais de <strong>2000 usinas solares parceiras</strong><br />
            espalhadas em todo Brasil gerando <em>energia limpa e renovável</em>
          </p>
        </header>

        {/* Full width carousel with accessibility */}
        <div 
          className="flex flex-col lg:flex-row gap-4 w-full"
          role="region"
          aria-label="Carrossel de usinas solares"
        >
          {solarPlants.map((plant, index) => (
            ...
            >
              ...
              <div className="absolute inset-0">
                <img
                  src={plant.image}
                  alt={`${plant.name} - Usina solar fotovoltaica localizada em ${plant.location} com capacidade de ${plant.capacity}`}
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8">
                <div className={`transition-all duration-700 ${
                  ...
                  <h3 
                    className={`font-bold text-white mb-3 transition-all duration-500 ${
                  ...
                  <div className={`transition-all duration-700 overflow-hidden ${
                    ...
                    <p className="text-solarien-primary font-semibold mb-3 text-lg" itemProp="address">
                      📍 {plant.location}
                    </p>
                    <p className="text-solarien-secondary font-semibold mb-4 text-lg">
                      ⚡ {plant.capacity} de capacidade instalada
                    </p>
                    {activeIndex === index && (
                      <p 
                        className="text-gray-300 leading-relaxed animate-fade-in text-lg"
              ...
              {/* Active Indicator */}
              <div 
                className={`absolute top-6 right-6 w-4 h-4 rounded-full transition-all duration-500 ${
        ...
        {/* Navigation Dots com acessibilidade */}
        <div className="flex justify-center mt-8 space-x-4" role="tablist" aria-label="Navegação do carrossel">
          {solarPlants.map((plant, index) => (
            <button
              key={index}
              onClick={() => setActiveIndex(index)}
