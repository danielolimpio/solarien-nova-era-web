        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative bg-gradient-to-br from-solarien-primary/10 via-transparent to-solarien-secondary/10 rounded-3xl p-6 md:p-8 backdrop-blur-sm border border-solarien-primary/20 shadow-2xl">
            ...
            <div className="mt-6 text-center">
              ...
              <a
                ...
                className="inline-block px-8 py-4 bg-gradient-to-r from-solarien-primary to-solarien-secondary text-white font-bold text-lg rounded-2xl hover:shadow-lg hover:shadow-solarien-primary/50 transition-all duration-300 transform hover:scale-105"
                style={{ color: '#015c3b' }}
              >
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-solarien-primary/10 hover:border-solarien-primary/30 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-solarien-primary to-solarien-secondary rounded-2xl flex items-center justify-center mx-auto mb-4 animate-[pulse_4s_ease-in-out_infinite]">
                <svg className="w-8 h-8" style={{ color: '#015c3b' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-solarien-secondary/10 hover:border-solarien-secondary/30 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-solarien-secondary to-solarien-tertiary rounded-2xl flex items-center justify-center mx-auto mb-4 animate-[pulse_4s_ease-in-out_infinite_0.5s]">
                <svg className="w-8 h-8" style={{ color: '#015c3b' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-solarien-tertiary/10 hover:border-solarien-tertiary/30 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-solarien-tertiary to-solarien-primary rounded-2xl flex items-center justify-center mx-auto mb-4 animate-[pulse_4s_ease-in-out_infinite_1s]">
                <svg className="w-8 h-8" style={{ color: '#015c3b' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
