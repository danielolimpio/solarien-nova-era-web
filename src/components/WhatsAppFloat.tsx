  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <button
        ...
        className="w-16 h-16 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-2xl hover:shadow-green-500/25 transition-all duration-300 animate-bounce hover:animate-none group"
